 ...
 *
 * Backends are created via the @link{BackendManager} class which reads the registered
...
public interface BackendMetadata {
    ...
    /**
     * @return A factory method for the backend. The method takes one parameter - a connection
     * string.
     */
